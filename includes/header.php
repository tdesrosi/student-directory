        ...
        <nav class="navbar navbar-expand-md navbar-light fixed-top bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <form class="form-inline mt-2 mt-md-0" style="margin: auto 0;" action="search.php" method="POST" name="search_form">
                    <input name="q" placeholder="Search..." autocomplete="off" class="form-control mr-sm-2" type="text" aria-label="Search" onkeyup="getLiveSearchUsers(this.value)" onkeydown="getLiveSearchUsers(this.value)" id="search_text_input">
